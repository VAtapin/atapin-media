...
- Текущий функциональный блок: этот commit — `Replace taxonomy cards with thin breadcrumb navigation`. Branch/upstream: `main` → `origin/main`.
- Предыдущий функциональный commit: `f3185e8` — `Compact Browser Studio controls and preview`.
