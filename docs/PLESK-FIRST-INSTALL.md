...
После успешной проверки создать две задачи **PHP-Skript ausführen** в Plesk по [таблице полей](PLESK-TASKS.md). Владелец выбрал планировщик Plesk; команду `plesk.sh services` не выполнять.
