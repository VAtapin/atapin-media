...
Кнопка ? в title bar каждой программы открывает отдельное окно справки поверх рабочего. Videos/Playlist явно различают сохранённую локальную структуру, локальные описания, физически доступный video original и внешний переход на YouTube. Сохранённые описания/картинки не выдаются за наличие видеозаписи. Распределение, коллекции, upload queue controls и полный адаптер Takeout остаются следующими этапами.
