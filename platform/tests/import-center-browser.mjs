...
try {
  ...
  await media.locator('[data-content-details][data-record-id]').waitFor();
  ...
  await content.locator('details').filter({has:page.locator('[data-repair-local-links]')}).locator('summary').click();
  await content.locator('[data-repair-local-links]').click();
  await content.getByText('Prüfung läuft im Hintergrund.',{exact:false}).waitFor();
  ...
  await media.locator('[data-content-list]').getByText(reviewedPost).click();
  assert.equal(await media.locator('[data-content-details] .content-assignment').count(),0);
  ...
  await media.locator('.content-playlist-items').getByText('Unavailable video').waitFor();
  const playlistEditor=media.locator('[data-playlist-editor]');
  await playlistEditor.locator('summary').click();
  await playlistEditor.locator('[data-playlist-action=down]').first().click();
  await media.locator('.content-playlist-items li').first().getByText('Unavailable video').waitFor();
  await playlistEditor.locator('summary').click();
  await playlistEditor.locator('[data-playlist-action=down]').first().click();
  await media.locator('.content-playlist-items li').first().getByText('Browser playlist video').waitFor();
