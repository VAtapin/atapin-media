...
return [
    ...
    'x' => ['public_url' => 'Öffentliche Profil-URL', 'oauth_client_id' => 'X OAuth Client-ID', 'oauth_client_secret' => 'X OAuth Client-Secret', 'hint' => 'Der Administrator hinterlegt zuerst Client-ID und Client-Secret. Danach kann das Konto über „Konto verbinden“ autorisiert werden; Benutzer-ID und Tokens werden automatisch übernommen.'],
