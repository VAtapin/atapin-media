...
class SettingsController extends Controller
{
    ...
    public function update(Request $request, Settings $settings)
    {
        ...
        $rules = match ($section) {
            ...
            'ai' => ['ai_provider' => ['required', Rule::in(['none','openai','anthropic','azure'])], 'ai_model' => 'nullable|string|max:120', 'ai_api_key' => 'nullable|string|max:2000', 'ai_enabled' => 'nullable|boolean', 'ai_auto_classify' => 'nullable|boolean','ai_chat_enabled'=>'nullable|boolean','ai_chat_daily_limit'=>'nullable|integer|min:0|max:1000','ai_input_price_per_million_usd'=>'nullable|numeric|min:0|max:100000','ai_output_price_per_million_usd'=>'nullable|numeric|min:0|max:100000'],
