...
class SettingsController extends Controller
{
    ...
    public function update(Request $request, Settings $settings)
    {
        ...
        $rules = match ($section) {
            ...
            'ai' => ['ai_provider' => ['required', Rule::in(['none','openai','anthropic','azure'])], 'ai_model' => 'nullable|string|max:120', 'ai_api_key' => 'nullable|string|max:2000', 'ai_enabled' => 'nullable|boolean', 'ai_auto_classify' => 'nullable|boolean'],
        ...
        foreach (['desktop_effects','ai_enabled','ai_auto_classify','publishing_approval_required','publishing_automation_enabled'] as $boolean) if (array_key_exists($boolean, $rules)) $values[$boolean] = $request->boolean($boolean);
