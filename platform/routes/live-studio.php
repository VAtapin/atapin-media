...
Route::middleware(['auth','can:content.publish'])->prefix('desktop/live-studio')->group(function(){
    ...
    Route::post('/events/{record}/browser',[BrowserLiveController::class,'start'])->middleware('throttle:10,1');
    ...
    Route::post('/sessions/{session}/heartbeat',[BrowserLiveController::class,'heartbeat'])->middleware('throttle:30,1');
    Route::delete('/sessions/{session}',[BrowserLiveController::class,'stop']);
