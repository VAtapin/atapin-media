<?php
require __DIR__.'/live-studio.php';
...
Route::get('/live/current',[\App\Http\Controllers\PublicLiveController::class,'current'])->middleware('throttle:60,1')->name('public.live-current');
