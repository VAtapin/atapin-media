...
Route::middleware('auth')->group(function(){
    ...
    Route::middleware('can:projects.manage')->group(function(){
        Route::get('/desktop/projects',[ProjectController::class,'index']);Route::post('/desktop/projects/{project}/cover',[ProjectController::class,'cover']);Route::get('/desktop/projects/{project}',[ProjectController::class,'show']);Route::delete('/desktop/projects/{project}',[ProjectController::class,'destroy']);Route::get('/desktop/tasks',[TaskController::class,'index']);
    ...
    Route::middleware('can:content.edit')->group(function(){
        ...
        Route::get('/desktop/taxonomy',[TaxonomyController::class,'index']);Route::post('/desktop/taxonomy',[TaxonomyController::class,'store']);Route::post('/desktop/taxonomy/{term}/cover',[TaxonomyController::class,'cover']);Route::patch('/desktop/taxonomy/{term}',[TaxonomyController::class,'update']);Route::delete('/desktop/taxonomy/{term}',[TaxonomyController::class,'destroy']);
