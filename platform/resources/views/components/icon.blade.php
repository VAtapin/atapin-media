@php($ownerIcon = ['home'=>'home', 'play'=>'play', 'book'=>'book', 'heart'=>'heart', 'settings'=>'settings'][$name] ?? null)
@if(config('platform.theme') === 'manna' && $ownerIcon)
<img class="icon owner-icon" src="/assets/brand/owner/icon-{{ $ownerIcon }}.png" alt="" aria-hidden="true">
@else
