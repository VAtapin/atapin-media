...
<head>
    ...
    <script src="/assets/desktop-content-columns.js?v=3" defer></script>
...
<main class="os-desktop" data-desktop data-storage-key="atapin.desktop.{{ auth()->id() }}.v1"
    ...
    <script src="/assets/desktop-content-library.js?v=12" defer></script>
