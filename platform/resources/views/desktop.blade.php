...
<head>
    ...
    <link rel="stylesheet" href="/assets/desktop-import-workflow.css?v=2">
    <script src="/assets/desktop-os.js?v=13" defer></script><script src="/assets/settings-tabs.js?v=5" defer></script><script src="/assets/desktop-media-library.js?v=11" defer></script><script src="/assets/desktop-import-center.js?v=6" defer></script>
</head>
<body class="os-body">
<main class="os-desktop" data-desktop data-storage-key="atapin.desktop.{{ auth()->id() }}.v1"
    ...
    <script src="/assets/desktop-content-assignment.js?v=3" defer></script>
