...
<head>
    ...
    <script src="/assets/desktop-os.js?v=12" defer></script><script src="/assets/settings-tabs.js?v=5" defer></script><script src="/assets/desktop-media-library.js?v=7" defer></script><script src="/assets/desktop-import-center.js?v=3" defer></script>
</head>
<body class="os-body">
