<section class="desktop-workspace" data-workspace="{{ $app }}" data-can-edit="{{ auth()->user()->hasPermission('content.edit')?'true':'false' }}" data-can-projects="{{ auth()->user()->hasPermission('projects.manage')?'true':'false' }}" data-can-publish="{{ auth()->user()->hasPermission('content.publish')?'true':'false' }}" data-can-moderate-reviews="{{ auth()->user()->hasPermission('community.moderate') && auth()->user()->hasPermission('shop.manage')?'true':'false' }}">
