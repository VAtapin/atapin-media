<section class="desktop-media-library" data-media-library data-can-content="{{ auth()->user()->hasPermission('content.edit') ? 'true' : 'false' }}" data-can-edit="{{ auth()->user()->hasPermission('media.edit') ? 'true' : 'false' }}" data-can-undo="{{ auth()->user()->hasPermission('media.edit') && auth()->user()->hasPermission('content.edit') ? 'true' : 'false' }}" data-user-id="{{ auth()->id() }}" data-library-url="{{ route('media.library') }}">
