...
@if($record?->id===$item['id'])<div class="public-document">@include('public.content-body')</div>
@if($record->kind==='post')
...
<section class="public-panel" id="guidelines"><h2>{{ __('public.community_guidelines') }}</h2><p>{{ __('public.community_review_notice') }}</p><div class="public-document">@include('public.rich-content',['content'=>app(\App\Services\Settings::class)->get('community_guidelines'),'empty'=>__('public.no_data')])</div></section>
